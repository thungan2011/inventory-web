...
const StockInventoryMaterialDetail = () => {
    return (
        <div className="flex flex-col gap-4 mt-4">
            <Card className="p-[18px]">
                <div className="flex gap-1 text-xl font-nunito font-medium">
                    <div>Mã phiếu kiểm kê</div>
                    <div className="text-brand-500">#KK201001</div>
                </div>
            </Card>
            ...
            <div className="grid grid-cols-2 gap-4">
                <Card className="col-span-1 p-[18px]">
                    ...
                    <div className="flex flex-col gap-3">
                        <ItemInfo label="Tên phiếu" value="Kiểm kê định kì tháng 09/2024" />
...
export default StockInventoryMaterialDetail;