...
const WarehouseAreaMaterialDetail = () => {
    return (
            ...
            <div className="grid grid-cols-3 gap-4">
                <Card className="col-span-2 p-[18px]">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <ItemInfo label="Khối lượng" value="12kg/thùng" />
                        <ItemInfo label="Số lượng sẳn có" value="35 thùng" />
                        <ItemInfo label="Số lượng tối thiểu" value="3 thùng" />
                        <ItemInfo label="Số lượng tối đa" value="100 thùng" />
...
export default WarehouseAreaMaterialDetail;