        ...
        return (
            <Form>
                ...
                <Select name="type" label="Loại"
                        options={[
                            { value: StorageAreaType.PRODUCT, label: StorageAreaTypeVietnamese[StorageAreaType.PRODUCT] },
                            { value: StorageAreaType.MATERIAL, label: StorageAreaTypeVietnamese[StorageAreaType.MATERIAL] },
                        ]} />
